        ...
        addbook.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (isbn.getText().toString().matches("")) {
                    JOptionPane.showMessageDialog(new JFrame(), "ISBN cannot be empty!");
                    return;
                }
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(new JFrame(), "Price must be a number!");
                    return;
                }
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(new JFrame(), "Borrowing copies must be an integer!");
                    return;
                }
